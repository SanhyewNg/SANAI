  ...
  return (
    <div
      className={joinClassNames(
        isDetailView ? "w-full xl:!w-[450px]" : "hidden xl:!flex w-[500px]",
        "flex bg-[#F7F5F7] dark:bg-gray-900 text-black dark:text-white overflow-auto border-r border-gray-200 dark:border-gray-800"
      )}
    >
      <div
      ...
      >
        ...
        >
          <img
            ...
            alt="image"
            className="object-cover w-[300px] aspect-[4/3] rounded-2xl"
          />
        </div>
