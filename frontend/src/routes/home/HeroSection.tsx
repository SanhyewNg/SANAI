  ...
  return (
    <div className="mt-2 flex items-center justify-center">
      <section className="relative flex  flex-col  items-center justify-center max-w-4xl">
        ...
        <div className="flex justify-start h-[200px] w-[200px]">
          <img src={IMAGE_GIF} className="dark:invert dark:rotate-180" />
        </div>
        {/* <div className="absolute bottom-0 text-start w-[330px]"> */}
        <div className="text-start w-[330px]">
          <h1 className="text-xl font-bold text-center mx-4 flex justify-center items-center">
            {title}
          </h1>
