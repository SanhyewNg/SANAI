...
async def root():
    """Check API Health"""
    return {"message": "Welcome to the backend API of SANAI !"}
...
api_router.include_router(
    manager.router, prefix="", tags=["Manager manages user accounts"]
)
api_router.include_router(
    developer.router, prefix="", tags=["Developer manages AI assistants"]
)

api_router.include_router(
    voice_service.router, prefix="/voice_service", tags=["Voice Service"]
)

api_router.include_router(
    assistant_responds.router, prefix="/assistant_responds", tags=["Assistant Service"]
)
api_router.include_router(
    translator_responds.router,
    prefix="/translator_responds",
    tags=["Translator Service"],
)

api_router.include_router(
    assistance_rooms.router, prefix="", tags=["Assistance Rooms Service"]
)
api_router.include_router(
    translation_records.router, prefix="", tags=["Translation Records Service"]
)
