...
env = Environment(
    loader=PackageLoader('app.email_sent', 'templates'),
...
class Email:
    def __init__(self, user: dict, url: str, email: List[EmailStr]):
        ...
        self.sender = 'Sanhyew Ng <admin@sanai.com>'
        self.email = email
        self.url = url
        pass
    ...
    async def sendPasswordReset(self):
        await self.sendMail('Reset your SANAI password', 'password_reset')
